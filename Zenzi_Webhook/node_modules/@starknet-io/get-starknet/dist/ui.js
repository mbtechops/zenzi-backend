...
function create_each_block_1(t) {
  ...
  return {
    ...
    m(m, p) {
      insert(m, e, p), append(e, n), append(e, o), l.m(e, null), s || (i = [
        listen(e, "click", u),
        listen(e, "keyup", d)
      ], s = !0);
    },
...
function create_each_block(t) {
  let e, r, n = t[20].name + "", o, s, i, a, c, l, u, d, m, p;
  return {
    c() {
    ...
    m(h, y) {
      insert(h, e, y), append(e, r), append(r, o), append(r, s), append(r, i), append(e, l), m || (p = [
        listen(r, "click", t[14]),
        listen(r, "keyup", t[15])
      ], m = !0);
    },
...
function create_fragment(t) {
  let e, r, n, o, s, i, a, c, l, u, d, m, p = t[4], h = [];
  ...
  return {
    c() {
      e = element("div"), r = element("main"), n = element("header"), o = element("h1"), o.textContent = "Connect a wallet", s = space(), i = element("span"), i.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 24 24" fill="currentColor" class="svelte-1mtuslq"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" class="svelte-1mtuslq"></path></svg>', a = space(), c = element("ul");
    ...
    p(g, [I]) {
      if (I & 26) {
        ...
        for (M = 0; M < p.length; M += 1) {
          const E = get_each_context_1(g, p, M);
          h[M] ? h[M].p(E, I) : (h[M] = create_each_block_1(E), h[M].c(), h[M].m(c, l));
        }
        for (; M < h.length; M += 1)
          h[M].d(1);
        h.length = p.length;
      ...
      if (I & 9) {
        ...
        for (M = 0; M < y.length; M += 1) {
          const E = get_each_context(g, y, M);
          w[M] ? w[M].p(E, I) : (w[M] = create_each_block(E), w[M].c(), w[M].m(c, null));
        }
        for (; M < w.length; M += 1)
          w[M].d(1);
        w.length = y.length;
...
var q = Object.defineProperty, Z = (t, e, r) => e in t ? q(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, S = (t, e, r) => (Z(t, typeof e != "symbol" ? e + "" : e, r), r), Y = (t, e, r) => {
  if (!e.has(t))
...
function generateSnapshotFromManifest(t) {
  ...
  if (!Object.keys(s).length) {
    var p;
    m = ((p = t.remotes) === null || p === void 0 ? void 0 : p.reduce(function(D, z) {
      var U, B = z.federationContainerName;
      return d.includes(B) ? U = a[B] : "version" in z ? U = z.version : U = z.entry, D[B] = {
        matchedVersion: U
      }, D;
    }, {})) || {};
  }
  Object.keys(s).forEach(function(D) {
    return m[D] = {
      matchedVersion: d.includes(D) ? a[D] : s[D]
    };
  });
  var h = t.metaData, y = h.remoteEntry, w = y.path, g = y.name, I = y.type, M = h.types, E = h.buildInfo.buildVersion, j = h.globalName, O = t.exposes, b = {
    version: c || "",
    buildVersion: E,
    globalName: j,
    ...
    modules: O == null ? void 0 : O.map(function(D) {
      return {
        moduleName: D.name,
        modulePath: D.path,
        assets: D.assets
  ...
  if (!((n = t.metaData) === null || n === void 0) && n.prefetchEntry) {
    var v = t.metaData.prefetchEntry, L = v.path, G = v.name, Q = v.type;
    b = _object_spread_props(_object_spread$1({}, b), {
      prefetchEntry: simpleJoinRemoteEntry(L, G),
      prefetchEntryType: Q
    });
  }
...
function generatePreloadAssets(t, e, r, n, o) {
  ...
  traverseModuleInfo(n, r, (h, y, w) => {
    ...
    if (E.length && "modules" in h) {
      var j;
      M = h == null || (j = h.modules) == null ? void 0 : j.reduce((b, A) => ((E == null ? void 0 : E.indexOf(A.moduleName)) !== -1 && b.push(A), b), []);
    }
    function O(b) {
      const A = b.map((v) => getResourceUrl(h, v));
      return g.filter ? A.filter(g.filter) : A;
    }
    if (M) {
      const b = M.length;
      for (let A = 0; A < b; A++) {
        ...
        t.hooks.lifecycle.handlePreloadModule.emit({
          ...
          remote: y,
          origin: t
        }), !getPreloaded(L) && (g.resourceCategory === "all" ? (s.push(...O(v.assets.css.async)), s.push(...O(v.assets.css.sync)), i.push(...O(v.assets.js.async)), i.push(...O(v.assets.js.sync))) : (g.resourceCategory = "sync") && (s.push(...O(v.assets.css.sync)), i.push(...O(v.assets.js.sync))), setPreloaded(L));
      }
    }
...
class FederationHost {
  ...
  initializeSharing(e = DEFAULT_SCOPE, r) {
    ...
    const s = n[e], i = (u, d) => {
      ...
      s[u] = s[u] || {};
      const y = s[u], w = y[p], g = Boolean(w && (w.eager || ((m = w.shareConfig) == null ? void 0 : m.eager)));
...
const wallets = [
  ...
  },
  {
    ...
    downloads: {
      ...
      ios: `https://link.braavos.app/dapp/${(V = ssrSafeWindow$1 == null ? void 0 : ssrSafeWindow$1.location) == null ? void 0 : V.host}`,
      android: `https://link.braavos.app/dapp/${($ = ssrSafeWindow$1 == null ? void 0 : ssrSafeWindow$1.location) == null ? void 0 : $.host}`
    }
  },
  {
...
class LocalStorageWrapper {
  constructor(e) {
    x(this, F), x(this, P), x(this, T, !1), x(this, _, void 0), x(this, R, void 0), S(this, "value"), k(this, R, e), C(this, P, W).call(this);
  }
  set(e) {
...
const enableWithVersion = async (t, e) => t ? main.enable(t, e).catch(() => null) : null, connect = async ({
  ...
  if (t === "neverAsk") {
    const m = (u = s.find((p) => p.id === (i == null ? void 0 : i.id))) != null ? u : s[0];
    return enableWithVersion(m, { silent_mode: !0 });
  }
  const a = await main.getAvailableWallets(o);
  if (t === "canAsk" && i) {
    const m = (d = s.find((p) => p.id === (i == null ? void 0 : i.id))) != null ? d : a.length === 1 ? a[0] : void 0;
    if (m)
