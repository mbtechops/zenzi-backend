...
var y = (A, D, M) => D in A ? c(A, D, { enumerable: !0, configurable: !0, writable: !0, value: M }) : A[D] = M;
var w = (A, D, M) => (y(A, typeof D != "symbol" ? D + "" : D, M), M);
import { Account as O } from "starknet";
import { C as s, a as g, b as i, P as t, U as u, r as x } from "./connector-c50f5de7.js";
...
class a extends s {
  ...
  async connect(M = {}) {
    ...
    }), this._wallet.on("networkChanged", (z, L) => {
      this.onNetworkChanged(z, L);
  ...
  async disconnect() {
    if (this.ensureWallet(), x(), !this._wallet)
      throw new i();
  ...
  ensureWallet() {
    const I = globalThis?.[`starknet_${this._options.id}`];
    I && (this._wallet = I);
  }
